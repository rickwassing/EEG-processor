...
Settings.maxDurSpindleSec = 2.5; % maximum duration of spindle in sec
...
Settings.fOrder        = 20.0;   % filter order for the sigma band
...
Settings.filterOrderSigmaCov = pop_firwsord('hamming', EEG.srate, 1);
